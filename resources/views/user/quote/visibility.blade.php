...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{__('Quote Page Visibility')}}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{__('Quote Page Visibility')}}</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form action="{{route('user.quote.visibility.update')}}" method="post">
          @csrf
          <div class="card-header">
              <div class="row">
                  <div class="col-lg-12">
                      <div class="card-title">{{__('Quote Page Visibility')}}</div>
                  </div>
              </div>
          </div>
            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  <label>{{__('Request a Quote Page Status')}} **</label>
